...
public class LogoutSpec {
    ...
    public static ResponseSpecification successfulLogoutResponseSpec = new ResponseSpecBuilder()
            ...
            .expectBody(matchesJsonSchemaInClasspath("schemas1/logout/successful_logout_response_schemas.json"))
            .expectBody(equalTo("{}"))
            .build();

    public static ResponseSpecification ReusedRefreshTokenLogoutResponseSpec = new ResponseSpecBuilder()
            .log(ALL)
